...
valid_queries_generation_cluster_options = [
    ClusterConf('r3.8xlarge', valid_queries_cluster_budget, 1, '4', '8', '15G', 'hvm'),
    ClusterConf('r3.4xlarge', valid_queries_cluster_budget, 1, '8', '4', '15G', 'hvm'),
    ClusterConf('r3.2xlarge', valid_queries_cluster_budget, 1, '14', '2', '15G', 'hvm'),
    ClusterConf('r3.xlarge', valid_queries_cluster_budget, 1, '28', '1', '15G', 'hvm'),
